...
class Classifier(nn.Module):
    ...
    def __init__(self, input_dim, lin_dim):
        ...
        self.lin6 = nn.Linear(lin_dim, lin_dim)
        self.lin7 = nn.Linear(lin_dim, lin_dim)
        self.lin8 = nn.Linear(lin_dim, lin_dim)
        self.lin9 = nn.Linear(lin_dim, lin_dim)
        self.lin10 = nn.Linear(lin_dim, lin_dim)
    ...
    def forward(self, x):
        ...
        y = F.relu(self.lin6(y))
        y = F.relu(self.lin7(y))
        y = F.relu(self.lin8(y))
        y = F.relu(self.lin9(y))
        y = F.relu(self.lin10(y))
